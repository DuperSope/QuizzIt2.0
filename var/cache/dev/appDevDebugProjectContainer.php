...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'donemanager' => 'getDonemanagerService',
            'errormanager' => 'getErrormanagerService',
            ...
            'questionmanager' => 'getQuestionmanagerService',
            'quizzmanager' => 'getQuizzmanagerService',
            'ratemanager' => 'getRatemanagerService',
            'reportmanager' => 'getReportmanagerService',
            ...
            'thememanager' => 'getThememanagerService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'GeneralBundle', ($this->targetDirs[3].'/app/Resources/GeneralBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'GeneralBundle', ($this->targetDirs[3].'/src/GeneralBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'QuizzBundle', ($this->targetDirs[3].'/app/Resources/QuizzBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'QuizzBundle', ($this->targetDirs[3].'/src/QuizzBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Ev655joNd5', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MtuCy1kToP', 0, '3K6N+hSC9DTHCUdA0ORcvw', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('heML0bQ9YI', 0, '3K6N+hSC9DTHCUdA0ORcvw', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NvLspVBLf6', 0, '3K6N+hSC9DTHCUdA0ORcvw', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 8889, 'dbname' => 'quizzit', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'serverVersion' => '5.5.38', 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/GeneralBundle/Entity'), 1 => ($this->targetDirs[3].'/src/QuizzBundle/Entity'), 2 => ($this->targetDirs[3].'/src/UserBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'GeneralBundle\\Entity');
        $c->addDriver($b, 'QuizzBundle\\Entity');
        $c->addDriver($b, 'UserBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('GeneralBundle' => 'GeneralBundle\\Entity', 'QuizzBundle' => 'QuizzBundle\\Entity', 'UserBundle' => 'UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_14d0aa9ec34a79cd9eb1508f1fadedacbc2498cbdb85fd4545a8c425b6d36b26');
    ...
    /**
     * Gets the 'donemanager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \QuizzBundle\Manager\DoneManager A QuizzBundle\Manager\DoneManager instance
     */
    protected function getDonemanagerService()
    {
        return $this->services['donemanager'] = new \QuizzBundle\Manager\DoneManager();
    }

    /**
     * Gets the 'errormanager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \QuizzBundle\Manager\ErrorManager A QuizzBundle\Manager\ErrorManager instance
     */
    protected function getErrormanagerService()
    {
        return $this->services['errormanager'] = new \QuizzBundle\Manager\ErrorManager();
    }
    ...
    /**
     * Gets the 'questionmanager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \QuizzBundle\Manager\QuestionManager A QuizzBundle\Manager\QuestionManager instance
     */
    protected function getQuestionmanagerService()
    {
        return $this->services['questionmanager'] = new \QuizzBundle\Manager\QuestionManager();
    }

    /**
     * Gets the 'quizzmanager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \QuizzBundle\Manager\QuizzManager A QuizzBundle\Manager\QuizzManager instance
     */
    protected function getQuizzmanagerService()
    {
        return $this->services['quizzmanager'] = new \QuizzBundle\Manager\QuizzManager($this->get('questionmanager'));
    }

    /**
     * Gets the 'ratemanager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \QuizzBundle\Manager\RateManager A QuizzBundle\Manager\RateManager instance
     */
    protected function getRatemanagerService()
    {
        return $this->services['ratemanager'] = new \QuizzBundle\Manager\RateManager();
    }

    /**
     * Gets the 'reportmanager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \QuizzBundle\Manager\ReportManager A QuizzBundle\Manager\ReportManager instance
     */
    protected function getReportmanagerService()
    {
        return $this->services['reportmanager'] = new \QuizzBundle\Manager\ReportManager();
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('/quizz/preview/*');
        ...
        $n = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $m, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($m, 'homepage'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'logout'));
    ...
    /**
     * Gets the 'thememanager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \GeneralBundle\Manager\ThemeManager A GeneralBundle\Manager\ThemeManager instance
     */
    protected function getThememanagerService()
    {
        return $this->services['thememanager'] = new \GeneralBundle\Manager\ThemeManager();
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'QuizzBundle:Form:rating.html.twig'), 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape' => 'filename', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'QuizzBundle:Form:rating.html.twig')), $this->get('security.csrf.token_manager', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
        $instance->addExtension(new \Twig_Extension_Debug());
        $instance->addExtension(new \Doctrine\Bundle\DoctrineBundle\Twig\DoctrineExtension());
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'DoctrineBundle', 6 => 'SensioFrameworkExtraBundle', 7 => 'GeneralBundle', 8 => 'QuizzBundle', 9 => 'UserBundle', 10 => 'AsseticBundle', 11 => 'BmatznerFontAwesomeBundle', 12 => 'AdminBundle', 13 => 'DebugBundle', 14 => 'WebProfilerBundle', 15 => 'SensioDistributionBundle', 16 => 'SensioGeneratorBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/GeneralBundle/Resources/views'), 'General');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('de95aeaab92fd1a26e8b233704d5c7c7c7562a77');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \UserBundle\Manager\UserManager A UserBundle\Manager\UserManager instance
     */
    protected function getUsermanagerService()
    {
        return $this->services['usermanager'] = new \UserBundle\Manager\UserManager();
    }
    ...
    {
        return $this->services['security.user.provider.concrete.db_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'UserBundle:User', 'username', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'GeneralBundle' => 'GeneralBundle\\GeneralBundle',
            ...
            'secret' => 'de95aeaab92fd1a26e8b233704d5c7c7c7562a77',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'de95aeaab92fd1a26e8b233704d5c7c7c7562a77',
            ...
            'twig.form.resources' => array(
                ...
                1 => 'QuizzBundle:Form:rating.html.twig',
            ),
