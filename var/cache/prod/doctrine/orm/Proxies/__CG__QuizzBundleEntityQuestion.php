 ...
 */
class Question extends \QuizzBundle\Entity\Question implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'QuizzBundle\\Entity\\Question' . "\0" . 'id', '' . "\0" . 'QuizzBundle\\Entity\\Question' . "\0" . 'questionType', '' . "\0" . 'QuizzBundle\\Entity\\Question' . "\0" . 'question', '' . "\0" . 'QuizzBundle\\Entity\\Question' . "\0" . 'answer', '' . "\0" . 'QuizzBundle\\Entity\\Question' . "\0" . 'quizz', '' . "\0" . 'QuizzBundle\\Entity\\Question' . "\0" . 'date', '' . "\0" . 'QuizzBundle\\Entity\\Question' . "\0" . 'deleted'];
        }
